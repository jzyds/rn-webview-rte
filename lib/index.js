...
let RTEWebview = /** @class */ (() => {
    class RTEWebview extends react_1.Component {
        ...
        render() {
            return (react_1.default.createElement(react_native_webview_1.WebView, { ref: r => (this.web_ref = r), allowFileAccess: true, style: { flex: 1 }, javaScriptEnabled: true, domStorageEnabled: true, originWhitelist: ['*'], hideKeyboardAccessoryView: true, allowsLinkPreview: false, bounces: false, allowsInlineMediaPlayback: true, scrollEnabled: false, source: react_native_1.Platform.OS === 'ios'
