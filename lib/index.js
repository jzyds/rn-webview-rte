...
let RTEWebview = /** @class */ (() => {
    class RTEWebview extends react_1.Component {
        ...
        componentDidMount() {
            ...
            this.keyboardDidShowListener = react_native_1.Keyboard.addListener('keyboardDidShow', this._keyboardDidShow);
        }
